  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar" style="height: auto;">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview">
          <a href="data.html">
            <i class="fa fa-table"></i> <span>Users Tables</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu" style="display: none;">
             <li><a href="data.html"><i class="fa fa-circle-o"></i>Users</a></li>
          </ul>
        </li>
...
<div class="jvectormap-label" style="display: none; left: 981px; top: 710px;">Chile</div></body></html>